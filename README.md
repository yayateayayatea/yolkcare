...
| Calorie & Fitness Tracker | Drop: Scope creep — physical load is already captured through AI input, a dedicated fitness tracker pulls focus away from the core burnout problem. | 
| In-App Messaging | Drop: Adds significant development complexity and duplicates what messaging apps already do better. | 
| Profile Panel | Grounds the experience in personal context and allows customisation of load categories to fit each student's lifestyle. | 
...
in_case_anything_failed: [link_to_backup]()
